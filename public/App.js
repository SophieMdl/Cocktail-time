...
const css = {
	...
	map: "{\"version\":3,\"file\":\"Header.svelte\",\"sources\":[\"Header.svelte\"],\"sourcesContent\":[\"<script>\\n  import { favorites } from './stores.js';\\n  import { Link } from 'svelte-routing';\\n</script>\\n\\n<style>\\n  .header {\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n  }\\n</style>\\n\\n<div class=\\\"header\\\">\\n  <Link to=\\\"/cocktails\\\">\\n    <h1>Cocktail time !</h1>\\n  </Link>\\n  {#if $favorites.length > 0}\\n    <Link to=\\\"/favorites\\\">\\n      My favorites({$favorites.length})\\n    </Link>\\n  {/if}\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAME,OAAO,cAAC,CAAC,AACP,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,AACrB,CAAC\"}"
};
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"header svelte-3ts8og"}">${validate_component(Link, "Link").$$render($$result, { to: "/cocktails" }, {}, {
...
${cocktail
  ...
  <div class="${"cocktail svelte-1c9f3t1"}"><div class="${"cocktail-img svelte-1c9f3t1"}"><img width="${"100%"}"${add_attribute("src", `${cocktail.strDrinkThumb}/preview`, 0)}${add_attribute("alt", cocktail.strDrink, 0)}>
      ${$favorites.some(fav => fav.idDrink === cocktail.idDrink)
		? `<button>Remove from favorites
        </button>`
		: `<button>Add to favorites
        </button>`}</div>
    <div><span class="${"bold svelte-1c9f3t1"}">Ingredients</span>
...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    ${validate_component(Route, "Route").$$render($$result, { path: "index", component: CocktailsList }, {}, {})}
