...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Link, "Link").$$render($$result, { to: "/index" }, {}, {
...
const css = {
	code: ".cocktails.svelte-4v11tx{width:100%;display:grid;grid-template-columns:repeat(6, 1fr);grid-gap:8px}figure.svelte-4v11tx,img.svelte-4v11tx{width:100%;margin:0;text-align:center}img.svelte-4v11tx{border-radius:200px}@media screen and (max-width: 780px){.cocktails.svelte-4v11tx{grid-template-columns:repeat(2, 1fr)}}",
	map: "{\"version\":3,\"file\":\"CocktailsGrid.svelte\",\"sources\":[\"CocktailsGrid.svelte\"],\"sourcesContent\":[\"\\n<script>\\n\\timport { Link } from \\\"svelte-routing\\\";\\n    import Header from './Header.svelte'\\n    \\n    export let cocktails;\\n</script>\\n\\n<style>\\n\\t.cocktails {\\n\\t\\twidth: 100%;\\n\\t\\tdisplay: grid;\\n\\t\\tgrid-template-columns: repeat(6, 1fr);\\n\\t\\tgrid-gap: 8px;\\n\\t}\\n\\n\\tfigure, img {\\n\\t\\twidth: 100%;\\n\\t\\tmargin: 0;\\n\\t\\ttext-align: center;\\n\\n\\t}\\n\\timg {\\n\\t\\tborder-radius : 200px;\\n\\t}\\n\\n\\ta {\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\t @media screen and (max-width: 780px){\\n\\t\\t.cocktails {\\n\\t\\t\\tgrid-template-columns: repeat(2, 1fr);\\n\\t\\t}\\n\\t }\\n\\t \\n</style>\\n\\n<div class=\\\"cocktails\\\">\\n{#if !cocktails}\\n\\t<p>Votre recherche n'a pas abouti</p>\\n{:else}\\n\\t{#each cocktails as cocktail}\\n\\t<Link to={`cocktails/${cocktail.idDrink}`}>\\n\\t\\t<figure>\\n\\t\\t\\t<img src={`${cocktail.strDrinkThumb}/preview`} alt={cocktail.strDrink}>\\n\\t\\t\\t<figcaption>{cocktail.strDrink}</figcaption>\\n\\t\\t</figure>\\n\\t</Link>\\n\\t{/each}\\n{/if}\\n</div>\"],\"names\":[],\"mappings\":\"AASC,UAAU,cAAC,CAAC,AACX,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,CACrC,QAAQ,CAAE,GAAG,AACd,CAAC,AAED,oBAAM,CAAE,GAAG,cAAC,CAAC,AACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,MAAM,AAEnB,CAAC,AACD,GAAG,cAAC,CAAC,AACJ,aAAa,CAAG,KAAK,AACtB,CAAC,AAMA,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,AACrC,UAAU,cAAC,CAAC,AACX,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,AACtC,CAAC,AACD,CAAC\"}"
};
...
const CocktailsGrid = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"cocktails svelte-4v11tx"}">${!cocktails
	? `<p>Votre recherche n&#39;a pas abouti</p>`
	: `${each(cocktails, cocktail => `${validate_component(Link, "Link").$$render($$result, { to: `cocktails/${cocktail.idDrink}` }, {}, {
			default: () => `<figure class="${"svelte-4v11tx"}"><img${add_attribute("src", `${cocktail.strDrinkThumb}/preview`, 0)}${add_attribute("alt", cocktail.strDrink, 0)} class="${"svelte-4v11tx"}">
...
const css$1 = {
	code: ".cocktail.svelte-1x8wrna{display:flex}.cocktail-img.svelte-1x8wrna{flex-basis:40%;margin-right:12px}",
	map: "{\"version\":3,\"file\":\"CocktailDetail.svelte\",\"sources\":[\"CocktailDetail.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Link } from 'svelte-routing'\\n    import { onMount } from 'svelte';\\n    import Header from './Header.svelte';\\n\\timport { cocktails, favorites } from './stores.js'\\n    \\n    export let id;\\n    let cocktail;\\n    let ingredients = [];\\n  \\n    const fetchCocktail = async() => {\\n        const res = await fetch(`https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=${id}`);\\n        return await res.json().then(res => res.drinks[0]);\\n    }\\n\\n\\tonMount(async() => {\\n        cocktail = await fetchCocktail()\\n        for (const [key, value] of Object.entries(cocktail)) {\\n            if(key.includes(\\\"strIngredient\\\") && value){\\n                ingredients = [\\n                    ...ingredients,\\n                    value\\n                ]\\n            }\\n        }\\n        \\n    });\\n        console.log($favorites)\\n\\n    const addToFavorites = () => {\\n        favorites.update(fav => [\\n            ...fav,\\n            cocktail\\n        ])\\n    }\\n\\n    const removeFromFavorites = () => {\\n        favorites.update(fav => fav.filter(f => f.idDrink !== cocktail.idDrink))\\n    }\\n\\n</script>\\n\\n<style>\\n    .cocktail {\\n        display: flex;\\n    }\\n    .cocktail-img {\\n        flex-basis: 40%;\\n        margin-right: 12px;\\n    }\\n\\n</style>\\n\\n<Link to=\\\"/cocktails\\\">Retour</Link>\\n<Header />\\n{#if cocktail}\\n    <h1>{cocktail.strDrink}</h1>\\n    <div class=\\\"cocktail\\\">\\n        <div class=\\\"cocktail-img\\\">\\n            <img width=\\\"100%\\\" src={`${cocktail.strDrinkThumb}`} alt={cocktail.strDrink}>\\n        </div>\\n        <div>\\n            <h4>Ingredients</h4>\\n            {#each ingredients as ingredient}\\n                <ul>\\n                    <li>{ingredient}</li>\\n                </ul>\\n            {/each}\\n        </div>\\n    </div>\\n    {#if $favorites.some(fav => fav.idDrink === cocktail.idDrink)}\\n        <button on:click={removeFromFavorites}>Retirer des favoris</button>\\n    {:else}\\n        <button on:click={addToFavorites}>Ajouter aux favoris</button>\\n    {/if}\\n    <h4>Instructions</h4>\\n    <span>{cocktail.strInstructions}</span>\\n\\n{:else}\\n\\t<p>...waiting</p>\\n{/if}\\n\\n\"],\"names\":[],\"mappings\":\"AA2CI,SAAS,eAAC,CAAC,AACP,OAAO,CAAE,IAAI,AACjB,CAAC,AACD,aAAa,eAAC,CAAC,AACX,UAAU,CAAE,GAAG,CACf,YAAY,CAAE,IAAI,AACtB,CAAC\"}"
};
...
${cocktail
    ...
    <div class="${"cocktail svelte-1x8wrna"}"><div class="${"cocktail-img svelte-1x8wrna"}"><img width="${"100%"}"${add_attribute("src", `${cocktail.strDrinkThumb}`, 0)}${add_attribute("alt", cocktail.strDrink, 0)}></div>
